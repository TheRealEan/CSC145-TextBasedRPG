...
1. Either create a new C++ empty project or use and existing one and navigate to where your code files are located.
```bash
...
git status # Verify that the adding and commiting was successful.
